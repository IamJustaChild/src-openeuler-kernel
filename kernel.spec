...
%changelog
* Thu Oct 31 2024 lvhuilin <kunkunyuz@qq.com> - 6.6.0-45.0.0.56
- cpufreq: add BPF based CPUFreq governor
...
* Wed Sep 18 2024 ZhangPeng <zhangpeng362@huawei.com> - 6.6.0-42.0.0.52
...
* Fri Sep 13 2024 Mingzheng Xing <xingmingzheng@iscas.ac.cn> - 6.6.0-41.0.0.51
- riscv kernel upgrade to 6.6.0-41.0.0
- Enable device mapper related configs to fix ISO image booting issue for RISC-V

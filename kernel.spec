...
%global Arch $(echo %{_host_cpu} | sed -e 's/i.86\\|x86_64/x86/' -e s/aarch64.*/arm64/ -e s/riscv64/riscv/)
...
%changelog
* Tue Aug 8 2023 Eustace <eusteuc@outlook.com> - 6.4.0-1.0.1.5
- Basic riscv arch build framework
